...
//                                   Vector<float>(0.0f, 0.0f, true), 45.0f);
    if (this->m_displayManager->IsStarted())
        this->m_enemy1 = new Enemy(this->m_displayManager->getWindow(), &this->m_deltaTime, this->m_player->getPos(),
